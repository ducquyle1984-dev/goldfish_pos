...
class Customer {
  ...
  factory Customer.fromFirestore(DocumentSnapshot doc) {
    ...
    return Customer(
      ...
      name: data['name'] ?? '',
      phone: data['phone'] ?? '',
      birthMonth: (data['birthMonth'] as num? ?? 1).toInt(),
      birthDay: (data['birthDay'] as num? ?? 1).toInt(),
      email: data['email'],
      address: data['address'],
      rewardPoints: (data['rewardPoints'] as num? ?? 0).toDouble(),
  ...
  factory Customer.fromJson(Map<String, dynamic> json) {
    return Customer(
      ...
      name: json['name'] ?? '',
      phone: json['phone'] ?? '',
      birthMonth: (json['birthMonth'] as num? ?? 1).toInt(),
      birthDay: (json['birthDay'] as num? ?? 1).toInt(),
      email: json['email'],
      address: json['address'],
      rewardPoints: (json['rewardPoints'] as num? ?? 0).toDouble(),
